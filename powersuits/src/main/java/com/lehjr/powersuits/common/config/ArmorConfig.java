...
public class ArmorConfig {
    ...
    private static final ModConfigSpec.DoubleValue HELM_1__MAX_HEAT = HELM_1__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 2.5, 0, 1000.0D);
    ...
    private static final ModConfigSpec.DoubleValue HELM_2__MAX_HEAT = HELM_2__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 5.0, 0, 1000.0D);
    ...
    private static final ModConfigSpec.DoubleValue CHESTPLATE_1__MAX_HEAT = CHESTPLATE_1__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 5.0, 0, 1000.0D);
    ...
    private static final ModConfigSpec.DoubleValue CHESTPLATE_2__MAX_HEAT = CHESTPLATE_2__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 10.0, 0, 1000.0D);

    private static final ModConfigSpec.Builder CHESTPLATE_3__SETTINGS_BUILDER = CHESTPLATE_2__SETTINGS_BUILDER.pop().push("Tier_3");
    private static final ModConfigSpec.IntValue CHESTPLATE_3__INVENTORY_SLOTS = CHESTPLATE_3__SETTINGS_BUILDER.defineInRange(MPSConstants.CONFIG_INVENTORY_SLOTS, 16, 0, 40);
    private static final ModConfigSpec.DoubleValue CHESTPLATE_3__MAX_HEAT = CHESTPLATE_3__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 20.0, 0, 1000.0D);

    private static final ModConfigSpec.Builder CHESTPLATE_4__SETTINGS_BUILDER = CHESTPLATE_3__SETTINGS_BUILDER.pop().push("Tier_4");
    private static final ModConfigSpec.IntValue CHESTPLATE_4__INVENTORY_SLOTS = CHESTPLATE_4__SETTINGS_BUILDER.defineInRange(MPSConstants.CONFIG_INVENTORY_SLOTS, 20, 0, 50);
    private static final ModConfigSpec.DoubleValue CHESTPLATE_4__MAX_HEAT = CHESTPLATE_4__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 40.0, 0, 1000.0D);
    ...
    private static final ModConfigSpec.IntValue LEGGINGS_2__INVENTORY_SLOTS = LEGGINGS_2__SETTINGS_BUILDER.defineInRange(MPSConstants.CONFIG_INVENTORY_SLOTS, 6, 0, 10);
    private static final ModConfigSpec.DoubleValue LEGGINGS_2__MAX_HEAT = LEGGINGS_2__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 6.0, 0, 1000.0D);

    private static final ModConfigSpec.Builder LEGGINGS_3__SETTINGS_BUILDER = LEGGINGS_2__SETTINGS_BUILDER.pop().push("Tier_3");
    private static final ModConfigSpec.IntValue LEGGINGS_3__INVENTORY_SLOTS = LEGGINGS_3__SETTINGS_BUILDER.defineInRange(MPSConstants.CONFIG_INVENTORY_SLOTS, 8, 0, 10);
    ...
    private static final ModConfigSpec.IntValue BOOTS_1__INVENTORY_SLOTS = BOOTS_1__SETTINGS_BUILDER.defineInRange(MPSConstants.CONFIG_INVENTORY_SLOTS, 2, 0, 10);
    private static final ModConfigSpec.DoubleValue BOOTS_1__MAX_HEAT = BOOTS_1__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 2.0, 0, 1000.0D);
    ...
    private static final ModConfigSpec.DoubleValue BOOTS_2__MAX_HEAT = BOOTS_2__SETTINGS_BUILDER.defineInRange(NuminaConstants.MAXIMUM_HEAT, 4.0, 0, 1000.0D);

    private static final ModConfigSpec.Builder BOOTS_3__SETTINGS_BUILDER = BOOTS_2__SETTINGS_BUILDER.pop().push("Tier_3");
    private static final ModConfigSpec.IntValue BOOTS_3__INVENTORY_SLOTS = BOOTS_3__SETTINGS_BUILDER.defineInRange(MPSConstants.CONFIG_INVENTORY_SLOTS, 8, 0, 10);
