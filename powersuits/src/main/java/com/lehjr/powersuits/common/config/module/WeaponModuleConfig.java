...
public class WeaponModuleConfig {
    ...
    private static final ModConfigSpec.DoubleValue RAILGUN_MODULE__ENERGY_CONSUMPTION_BASE= RAILGUN_MODULE__SETTINGS_BUILDER.defineInRange(MPSConstants.ENERGY_CONSUMPTION_BASE, 500, 0, 100000.0D);
    private static final ModConfigSpec.DoubleValue RAILGUN_MODULE__HEAT_EMISSION_BASE= RAILGUN_MODULE__SETTINGS_BUILDER.defineInRange(MPSConstants.HEAT_EMMISSION_BASE, 2, 0, 100000.0D);
    private static final ModConfigSpec.DoubleValue RAILGUN_MODULE__TOTAL_IMPULSE_VOLTAGE_MULTIPLIER = RAILGUN_MODULE__SETTINGS_BUILDER.defineInRange(MPSConstants.TOTAL_IMPULSE_VOLTAGE_MULTIPLIER, 2500, 0, 100000.0D);
    private static final ModConfigSpec.DoubleValue RAILGUN_MODULE__ENERGY_CONSUMPTION_VOLTAGE_MULTIPLIER = RAILGUN_MODULE__SETTINGS_BUILDER.defineInRange(MPSConstants.ENERGY_CONSUMPTION_VOLTAGE_MULTIPLIER, 2500, 0, 100000.0D);
    private static final ModConfigSpec.DoubleValue RAILGUN_MODULE__HEAT_EMISSION_VOLTAGE_MULTIPLIER = RAILGUN_MODULE__SETTINGS_BUILDER.defineInRange(MPSConstants.HEAT_EMMISSION_VOLTAGE_MULTIPLIER, 10, 0, 100000.0D);
