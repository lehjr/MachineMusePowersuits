...
//
// TODO: On hold until I figure out how to render the beam
//
...
//
//    /*
//    Constants that shouldn't be recalculated every loop
//    1/Math.PI = 0.318309886
//    0.5 * Math.PI = 1.570796327
//
//
//    */
//
//    static final float HALF_PI = (float) (Math.PI * 0.5);
//    static final float DIV_BY_PI = (float) (1/Math.PI);
//    static final float QUARTER_PI = (float) (Math.PI * 0.25);
//
//
//    // move to power fist renderer when finished
//    public void render(Guardian entity, Player player, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, double x, double y, double z) {
...
//
//            /*
//                // maybe calculate this based on use duration?
...
//            // center of source?
//            Vec3 vec31 = this.getPosition(player, (double)f3, partialTicks);
//
//            Vec3 vec32 = vec3.subtract(vec31); // length?
...
//            poseStack.mulPose(Axis.YP.rotationDegrees((HALF_PI - f6) * (180.0F * DIV_BY_PI)));
//            poseStack.mulPose(Axis.XP.rotationDegrees(f5 * (180.0F * DIV_BY_PI)));
//            int i = 1;
...
//            float f9 = 0.2F;
//            float f10 = 0.282F;
//            float f11 = Mth.cos(f7 + (QUARTER_PI * 3.0F)) * f10;
//            float f12 = Mth.sin(f7 + (QUARTER_PI * 3.0F)) * f10;
//            float f13 = Mth.cos(f7 + QUARTER_PI) * f10;
//            float f14 = Mth.sin(f7 + QUARTER_PI) * f10;
//            float f15 = Mth.cos(f7 + (QUARTER_PI * 5.0F)) * f10;
//            float f16 = Mth.sin(f7 + (QUARTER_PI * 5.0F)) * f10;
//            float f17 = Mth.cos(f7 + QUARTER_PI * 7.0F) * f10;
//            float f18 = Mth.sin(f7 + (QUARTER_PI * 7.0F)) * f10;
...
//            float f23 = Mth.cos(f7 + HALF_PI) * f9;
//            float f24 = Mth.sin(f7 + HALF_PI) * f9;
//            float f25 = Mth.cos(f7 + (float) (HALF_PI * 3.0)) * f9;
//            float f26 = Mth.sin(f7 + (float) (HALF_PI * 3.0)) * f9;
//            float f27 = 0.0F;
//            float f28 = 0.4999F;
//            float f29 = -1.0F + f2;
...
//            vertex(vertexconsumer, pose, f19, f4, f20, j, k, l, f28, f30);
//            vertex(vertexconsumer, pose, f19, f27, f20, j, k, l, f28, f29);
//            vertex(vertexconsumer, pose, f21, f27, f22, j, k, l, f27, f29);
//            vertex(vertexconsumer, pose, f21, f4, f22, j, k, l, f27, f30);
//            vertex(vertexconsumer, pose, f23, f4, f24, j, k, l, f28, f30);
//            vertex(vertexconsumer, pose, f23, f27, f24, j, k, l, f28, f29);
//            vertex(vertexconsumer, pose, f25, f27, f26, j, k, l, f27, f29);
//            vertex(vertexconsumer, pose, f25, f4, f26, j, k, l, f27, f30);
//            float f31 = f27;
//            if (entity.tickCount % 2 == 0) {
//                f31 = 0.5F;
//            }
//
//            vertex(vertexconsumer, pose, f11, f4, f12, j, k, l, 0.5F, f31 + 0.5F);
//            vertex(vertexconsumer, pose, f13, f4, f14, j, k, l, 1.0F, f31 + 0.5F);
//            vertex(vertexconsumer, pose, f17, f4, f18, j, k, l, 1.0F, f31);
//            vertex(vertexconsumer, pose, f15, f4, f16, j, k, l, 0.5F, f31);
//            poseStack.popPose();
//        }
//    }
//
...
////
////import com.lehjr.powersuits.basemod.MPSConstants;
////import com.lehjr.powersuits.item.module.AbstractPowerModule;
////import com.lehjr.numina.common.capabilities.module.powermodule.IConfig;
////import com.lehjr.numina.common.capabilities.module.powermodule.EnumModuleCategory;
////import com.lehjr.numina.common.capabilities.module.powermodule.EnumModuleTarget;
////import com.lehjr.numina.common.capabilities.module.rightclick.IRightClickModule;
////import com.lehjr.numina.common.capabilities.module.tickable.PlayerTickModule;
////import com.lehjr.numina.common.energy.ElectricItemUtils;
////import com.lehjr.numina.heat.HeatUtils;
////import com.lehjr.numina.nbt.NBTUtils;
////import net.minecraft.world.entity.LivingEntity;
////import net.minecraft.world.entity.player.Player;
////import net.minecraft.world.item.ItemStack;
...
////
////
////            private final ResourceLocation GUARDIAN_BEAM_TEXTURE = ResourceLocation.fromNamespaceAndPath("textures/entity/guardian_beam.png");
////
////
...
//////                    buffer.pos(lvt_52_1_, lvt_21_1_, lvt_54_1_).tex(0.4999D, lvt_76_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_52_1_, 0.0D, lvt_54_1_).tex(0.4999D, lvt_74_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_56_1_, 0.0D, lvt_58_1_).tex(0.0D, lvt_74_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_56_1_, lvt_21_1_, lvt_58_1_).tex(0.0D, lvt_76_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_60_1_, lvt_21_1_, lvt_62_1_).tex(0.4999D, lvt_76_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_60_1_, 0.0D, lvt_62_1_).tex(0.4999D, lvt_74_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_64_1_, 0.0D, lvt_66_1_).tex(0.0D, lvt_74_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_64_1_, lvt_21_1_, lvt_66_1_).tex(0.0D, lvt_76_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    double lvt_78_1_ = 0.0D;
//////                    if (source.ticksExisted % 2 == 0) {
//////                        lvt_78_1_ = 0.5D;
//////                    }
//////                    buffer.pos(lvt_36_1_, lvt_21_1_, lvt_38_1_).tex(0.5D, lvt_78_1_ + 0.5D).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_40_1_, lvt_21_1_, lvt_42_1_).tex(1.0D, lvt_78_1_ + 0.5D).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_48_1_, lvt_21_1_, lvt_50_1_).tex(1.0D, lvt_78_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    buffer.pos(lvt_44_1_, lvt_21_1_, lvt_46_1_).tex(0.5D, lvt_78_1_).setColor(lvt_29_1_, lvt_30_1_, lvt_31_1_, 255);
//////                    tessellator.draw();
