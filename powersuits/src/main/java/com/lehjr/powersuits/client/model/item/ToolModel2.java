...
public class ToolModel2<T extends Entity> extends EntityModel<T> {
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, int color) {
        mainarm.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        armorright.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        armorleft.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        wristtopright.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        wristtopleft.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        wristbottomright.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        wristbottomleft.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        index1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        middlefinger1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        ringfinger1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        pinky1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        thumb1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        fingerguard.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        crystalholder.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        crystal.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportright1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportright2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportright3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportright4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportright5.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportbaseright.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        palm.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportbaseleft.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportleftfront.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportrightfront.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportleft1.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportleft2.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportleft3.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportleft4.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
        supportleft5.render(poseStack, vertexConsumer, packedLight, packedOverlay, color);
    }
}
