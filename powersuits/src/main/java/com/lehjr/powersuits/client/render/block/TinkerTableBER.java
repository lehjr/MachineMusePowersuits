package com.lehjr.powersuits.client.render.block;
...
//                    poseStack.mulPose(Vector3f.YP.rotationDegrees(90f));
        ...
        model.renderToBuffer(poseStack, bufferSource.getBuffer(RenderType.itemEntityTranslucentCull(TinkerTableModel.TEXTURE)), packedLight, packedOverlay, Color.WHITE.getARGBInt());
        poseStack.popPose();
    }
}