...
public enum ModelBakeEventHandler {
    INSTANCE;
    public static final ModelResourceLocation plasmaBall = new ModelResourceLocation(ResourceLocation.fromNamespaceAndPath(MPSConstants.MOD_ID, "entity/plasma"), "entity");
