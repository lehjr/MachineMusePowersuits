...
public class MPSRCConstants {
    ...
    public static final ResourceLocation RECIPE_WORKBENCH__REGNAME = ResourceLocation.fromNamespaceAndPath(MOD_ID,  "recipe_workbench");
    public static final ResourceLocation RECIPE_WORKBENCH_TYPE__REG_NAME = ResourceLocation.fromNamespaceAndPath(MOD_ID,  "recipe_workbench_container_type");
}
