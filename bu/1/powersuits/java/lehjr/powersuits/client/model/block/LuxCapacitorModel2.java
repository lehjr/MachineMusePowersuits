...
public class LuxCapacitorModel2 extends Model {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "luxcapacitor"), "main");
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        baseLower.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
        baseUpper.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
