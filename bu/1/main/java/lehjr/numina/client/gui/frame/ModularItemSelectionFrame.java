...
public class ModularItemSelectionFrame extends AbstractGuiFrame {
    ...
    public Optional<IModularItem> getModularItemCapability () {
        Optional<IModularItem> modularItemCap = NuminaCapabilities.getCapability(getModularItemOrEmpty(), NuminaCapabilities.MODULAR_ITEM);

        if(modularItemCap.isEmpty()) {
            modularItemCap = NuminaCapabilities.getCapability(getModularItemOrEmpty(), NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    Optional<IModularItem> getModularItemCapability (EquipmentSlot type) {
        Optional<IModularItem> modularItemCap = NuminaCapabilities.getCapability(getStack(type), NuminaCapabilities.MODULAR_ITEM);

        if(modularItemCap.isEmpty()) {
            modularItemCap = NuminaCapabilities.getCapability(getStack(type), NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
                    .map(IModularItem.class::cast);
        }
