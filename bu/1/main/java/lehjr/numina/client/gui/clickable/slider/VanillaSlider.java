...
public class VanillaSlider extends AbstractSlider {
    ...
    public void renderBg(GuiGraphics gfx, int mouseX, int mouseY, float frameTime) {
        ...
        // Look in /assets/minecraft/atlases/gui.json
        RenderSystem.setShaderTexture(0, AbstractWidget.WIDGETS_LOCATION); // FIXME: textures have been broken up into sprites now?
