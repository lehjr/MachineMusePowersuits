...
//        float swingProgressy = MathHelper.sin(MathHelper.sqrt(swingProgress) * (float) Math.PI);
//        GL11.glTranslatef(-swingProgressy * 0.3F, MathHelper.sin(MathHelper.sqrt(swingProgress) * (float) Math.PI * 2.0F) * 0.4F, -swingProgressx * 0.4F);
...
//        swingProgressy = MathHelper.sin(MathHelper.sqrt(swingProgress) * (float) Math.PI);
...
//        Render render = RenderManager.instance.getEntityRenderObject(mc.player); // EntityRendererManager?
