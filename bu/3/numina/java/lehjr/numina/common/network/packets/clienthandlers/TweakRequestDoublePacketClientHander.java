...
public class TweakRequestDoublePacketClientHander {
    public static void handlePacket(EquipmentSlot type, ResourceLocation moduleRegName, String tweakName, double tweakValue) {
            ...
            if (moduleRegName != null && tweakName != null) {
                NuminaCapabilities.getCapability(ItemUtils.getItemFromEntitySlot(player, type), NuminaCapabilities.MODULAR_ITEM)
                        .ifPresent(iItemHandler -> iItemHandler.setModuleTweakDouble(moduleRegName, tweakName, tweakValue));


                NuminaCapabilities.getCapability(ItemUtils.getItemFromEntitySlot(player, type), NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
                        .ifPresent(iItemHandler -> iItemHandler.setModuleTweakDouble(moduleRegName, tweakName, tweakValue));
            }
    }
}
