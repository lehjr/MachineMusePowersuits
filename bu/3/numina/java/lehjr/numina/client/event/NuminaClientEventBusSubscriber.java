...
import forge.client.NuminaObjLoader;
...
public class NuminaClientEventBusSubscriber {
    ...
    public static void registerScreen(RegisterMenuScreensEvent event) {
        event.register(NuminaObjects.CHARGING_BASE_CONTAINER_TYPE.get(), ChargingBaseScreen::new);
        event.register(NuminaObjects.ARMOR_STAND_CONTAINER_TYPE.get(), ArmorStandScreen::new);
    }
    ...
    public static void modelRegistry(ModelEvent.RegisterGeometryLoaders event) {
        event.register(new ResourceLocation(NuminaConstants.MOD_ID, "obj"), NuminaObjLoader.INSTANCE);
    }
