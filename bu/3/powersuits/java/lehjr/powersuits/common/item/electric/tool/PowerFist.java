...
//            return fallback;
//        }
        InteractionResultHolder<ItemStack> tmp = NuminaCapabilities.getCapability(fist, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    public boolean mineBlock(ItemStack powerFist, Level worldIn, BlockState state, BlockPos pos, LivingEntity entityLiving) {
        return NuminaCapabilities.getCapability(powerFist, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    public void onUseTick(Level level, LivingEntity entity, ItemStack itemStack, int ticksRemaining) {
        if(NuminaCapabilities.getCapability(itemStack, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    public InteractionResult onItemUseFirst(ItemStack itemStack, UseOnContext context) {
        ...
        return NuminaCapabilities.getCapability(context.getItemInHand(), NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    public float getDestroySpeed(ItemStack stack, BlockState pState) {
        return NuminaCapabilities.getCapability(stack, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    public InteractionResult interactLivingEntity(ItemStack itemStackIn, Player player, LivingEntity entity, InteractionHand hand) {
        return NuminaCapabilities.getCapability(itemStackIn, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
                .map(handler-> NuminaCapabilities.getCapability(handler.getActiveModule(), NuminaCapabilities.POWER_MODULE)
    ...
    public void releaseUsing(ItemStack stack, Level worldIn, LivingEntity entityLiving, int timeLeft) {
        NuminaCapabilities.getCapability(stack, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    public boolean isCorrectToolForDrops(ItemStack itemStack, BlockState state) {
        return NuminaCapabilities.getCapability(itemStack, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
    ...
    public boolean hurtEnemy(ItemStack itemStack, LivingEntity target, LivingEntity attacker) {
        if (attacker instanceof Player) {
            NuminaCapabilities.getCapability(itemStack, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
                    .ifPresent(iItemHandler ->
                            NuminaCapabilities.getCapability(
                                    iItemHandler.getOnlineModuleOrEmpty(MPSRegistryNames.MELEE_ASSIST_MODULE),
                                            NuminaCapabilities.POWER_MODULE)
    ...
    public boolean canContinueUsing(ItemStack oldStack, ItemStack newStack) {
        return NuminaCapabilities.getCapability(oldStack, NuminaCapabilities.MODE_CHANGING_MODULAR_ITEM)
