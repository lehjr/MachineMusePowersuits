...
/**
 * Same as ForgeEnergy/RF, except for heat and max amount determines limit before player takes damage
 */
public interface IHeatStorage {
    ...
    /**
     * Condensed version of MaxHeatReceive and MaxHeatExtract
     *
     * @return
     */
    double getMaxHeatTransfer();
