...
public class VanillaSlider extends AbstractSlider {
    ...
    private static final ResourceLocation SLIDER_SPRITE = ResourceLocation.fromNamespaceAndPath("minecraft","widget/slider");
    private static final ResourceLocation HIGHLIGHTED_SPRITE = ResourceLocation.fromNamespaceAndPath("minecraft","widget/slider_highlighted");
    private static final ResourceLocation SLIDER_HANDLE_SPRITE = ResourceLocation.fromNamespaceAndPath("minecraft","widget/slider_handle");
    private static final ResourceLocation SLIDER_HANDLE_HIGHLIGHTED_SPRITE = ResourceLocation.fromNamespaceAndPath("minecraft","widget/slider_handle_highlighted");
