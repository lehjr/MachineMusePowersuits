...
public class VanillaButton extends Clickable {
    ...
    Component label;
    static final ResourceLocation BUTTON = new ResourceLocation("widget/button");
    static final ResourceLocation BUTTON_DISABLED = new ResourceLocation("widget/button_disabled");
    static final ResourceLocation BUTTON_HIGHLIGHTED = new ResourceLocation("widget/button_highlighted");
