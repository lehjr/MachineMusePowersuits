        ...
        if (player != null) {
            ...
            for (int i = 0; i < net.minecraft.world.entity.player.Inventory.getSelectionSize(); i++) {
                ...
                if (!itemStack.isEmpty()) {
                    ...
                    int finalI = i;
                    modeChangingItemCap.ifPresent(handler -> handler.drawModeChangeIcon(player, finalI, gfx, gfx.guiWidth(), gfx.guiHeight()));
                    ...
                    if (modeChangingItemCap.isEmpty()) {
                        ...
                        foreignModuleCap.ifPresent(fmc -> {
                            ...
                            storedMCIC.ifPresent(cap -> {
                                cap.drawModeChangingModularItemIcon(player, finalI, gfx, gfx.guiWidth(), gfx.guiHeight());
                            });
                        });
                    }
                }
