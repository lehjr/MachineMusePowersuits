...
public class HeatUtils {
    ...
    public static double getItemMaxHeat(@Nonnull ItemStack stack) {
        return NuminaCapabilities.getCapability(stack, NuminaCapabilities.HEAT).map(IHeatStorage::getMaxHeatStored).orElse(0D);
    }

    public static double getItemHeat(@Nonnull ItemStack stack) {
        return NuminaCapabilities.getCapability(stack, NuminaCapabilities.HEAT).map(IHeatStorage::getHeatStored).orElse(0D);
    }
