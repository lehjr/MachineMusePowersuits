...
import net.machinemuse.powersuits.common.powermodule.armor.DiamondPlatingModule;
import net.machinemuse.powersuits.common.powermodule.armor.EnergyShieldModule;
import net.machinemuse.powersuits.common.powermodule.armor.IronPlatingModule;
import net.machinemuse.powersuits.common.powermodule.armor.LeatherPlatingModule;
import net.machinemuse.powersuits.common.powermodule.cosmetic.TransparentArmorModule;
import net.machinemuse.powersuits.common.powermodule.energy_generation.AdvancedSolarGenerator;
import net.machinemuse.powersuits.common.powermodule.energy_generation.KineticGeneratorModule;
import net.machinemuse.powersuits.common.powermodule.energy_generation.SolarGeneratorModule;
import net.machinemuse.powersuits.common.powermodule.energy_generation.ThermalGeneratorModule;
import net.machinemuse.powersuits.common.powermodule.energy_storage.AdvancedBatteryModule;
import net.machinemuse.powersuits.common.powermodule.energy_storage.BasicBatteryModule;
import net.machinemuse.powersuits.common.powermodule.energy_storage.EliteBatteryModule;
import net.machinemuse.powersuits.common.powermodule.energy_storage.UltimateBatteryModule;
import net.machinemuse.powersuits.common.powermodule.environmental.*;
import net.machinemuse.powersuits.common.powermodule.mining_enhancement.*;
import net.machinemuse.powersuits.common.powermodule.movement.*;
import net.machinemuse.powersuits.common.powermodule.special.ClockModule;
import net.machinemuse.powersuits.common.powermodule.special.CompassModule;
import net.machinemuse.powersuits.common.powermodule.special.InvisibilityModule;
import net.machinemuse.powersuits.common.powermodule.special.MagnetModule;
import net.machinemuse.powersuits.common.powermodule.tool.*;
import net.machinemuse.powersuits.common.powermodule.vision.BinocularsModule;
import net.machinemuse.powersuits.common.powermodule.vision.NightVisionModule;
import net.machinemuse.powersuits.common.powermodule.vision.ThaumGogglesModule;
import net.machinemuse.powersuits.common.powermodule.weapon.*;

import static net.machinemuse.numina.common.module.EnumModuleTarget.*;
