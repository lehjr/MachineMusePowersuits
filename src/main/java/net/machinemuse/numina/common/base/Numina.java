package net.machinemuse.numina.common.base;
...
public enum Numina {
    ...
    @SidedProxy(clientSide = "net.machinemuse.numina.client.proxy.ClientProxy", serverSide = "net.machinemuse.numina.common.proxy.CommonProxy")
