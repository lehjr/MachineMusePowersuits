...
public class RecipeGen {
    ...
    public RecipeGen(MPSRCMenu containerIn, RecipeOptionsFrame recipeOptionsIn) {
    ...
    ItemStack getStack(int slot) {
        if(slot > -1 && slot < container.slots.size()) {
    ...
    JsonObject getStackJson(@Nonnull ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            ...
            if (ItemUtils.getRegistryName(stack.getItem()) == null) {
