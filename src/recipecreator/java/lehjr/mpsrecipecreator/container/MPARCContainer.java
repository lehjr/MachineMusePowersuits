...
//
//public class MPARCAbstractContainerMenu extends AbstractContainerMenu {
//    /**
...
//
//    public MPARCAbstractContainerMenu(int windowID, Inventory playerInventory) {
//        this(windowID, playerInventory, ContainerLevelAccess.field_221489_a);
//    }
//
//    public MPARCAbstractContainerMenu(int windowID, Inventory playerInventory, ContainerLevelAccess posCallable) {
...
//
//    @Override
//    public ItemStack func_184996_a(int slotIndex, int mousebtn, ClickType clickTypeIn, Player player) {
...
//                    if (!stackInSlot.isEmpty() && func_195929_a(stackInSlot, stackHeld) /* && (slotIndex == 0)*/) {
//                        if (stackInSlot.getCount() < stackInSlot.func_77976_d()) stackInSlot.func_190917_f(1);
//                    } else {
...
//            }
//        } else {
//            stack = super.func_184996_a(slotIndex, mousebtn, clickTypeIn, player);
//        }
//        return stack;
//    }
//
...
//
////    @Override
////    protected void clearAbstractContainerMenu(Player p_193327_1_, World p_193327_2_, SimpleContainer p_193327_3_) {
////        super.clearAbstractContainerMenu(p_193327_1_, p_193327_2_, p_193327_3_);
////    }
//}
