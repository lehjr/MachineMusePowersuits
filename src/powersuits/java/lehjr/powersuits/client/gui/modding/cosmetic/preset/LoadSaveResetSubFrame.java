...
////            if (itemNBT.contains(TagConstants.RENDER,Constants.NBT.TAG_COMPOUND)) {
////                BiMap<String, CompoundTag> presetMap = MPSSettings::getModuleConfig.getCosmeticPresets(itemStack);
////                if (presetMap.containsValue(itemNBT.getCompound(TagConstants.RENDER))) {
////                    String name = presetMap.inverse().get(itemNBT.getCompound(TagConstants.RENDER));
...
////                            MPSPackets.sendToServer(new MusePacketCosmeticInfo(player.getEntityId(), itemSelector.getSelectedItem().inventorySlot, TagConstants.RENDER, nbt));
////                        }
////                        // cancel creation
...
////                            MPSPackets.sendToServer(new MusePacketCosmeticInfo(Minecraft.getInstance().player.getEntityId(), this.getSelectedItem().inventorySlot, TagConstants.RENDER, nbt));
////                        }
////                    } else if (resetButton.hitBox(x, y)) {
////                        if (isValidItem(getSelectedItem(), getEquipmentSlot())) {
////                            MPSPackets.sendToServer(new MusePacketCosmeticPreset(Minecraft.getInstance().player.getEntityId(), this.getSelectedItem().inventorySlot, "Default"));
