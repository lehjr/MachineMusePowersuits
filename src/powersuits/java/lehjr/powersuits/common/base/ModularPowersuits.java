...
//        modEventBus.addListener(this::addCreative);
        ...
        modContainer.registerConfig(ModConfig.Type.CLIENT, MPSClientConfig.CLIENT_SPEC, ConfigHelper.setupConfigFile("powersuits-client-only.toml", NuminaConstants.MOD_ID).getAbsolutePath());
        modContainer.registerConfig(ModConfig.Type.COMMON, MPSCommonConfig.COMMON_SPEC, ConfigHelper.setupConfigFile("powersuits-common.toml", NuminaConstants.MOD_ID).getAbsolutePath());
