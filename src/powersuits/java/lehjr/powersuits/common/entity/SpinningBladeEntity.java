...
public class SpinningBladeEntity extends ThrowableProjectile {
    ...
    public SpinningBladeEntity(Level worldIn, LivingEntity shootingEntity) {
        ...
        if (shootingEntity instanceof Player) {
            ...
            NuminaCapabilities.getModeChangingModularItemCapability(this.shootingItem)
                    .map(IModeChangingItem.class::cast)
                    .flatMap(iModeChangingItem -> NuminaCapabilities.getPowerModuleCapability(iModeChangingItem.getActiveModule())).ifPresent(m -> atomicDamage.getAndAdd(m.applyPropertyModifiers(MPSConstants.BLADE_DAMAGE)));
...
//                            EnchantmentHelper.getItemEnchantmentLevel(BuiltInRegistries.ENCHANTMENT.get(new ResourceLocation("fortune")), this.shootingItem));
