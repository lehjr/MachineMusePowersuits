...
public class FluidStorageConfig {
    ...
    private static final ModConfigSpec.DoubleValue COOLANT_TANK_MODULE_1__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER = COOLANT_TANK_MODULE_1__BUILDER.defineInRange(MPSConstants.ENERGY_CONSUMPTION_COOLING_BONUS_MULTIPLIER , 1, 0, 1000000D);
    ...
    private static final ModConfigSpec.DoubleValue COOLANT_TANK_MODULE_2__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER = COOLANT_TANK_MODULE_2__BUILDER.defineInRange(MPSConstants.ENERGY_CONSUMPTION_COOLING_BONUS_MULTIPLIER , 1, 0, 1000000D);
    ...
    private static final ModConfigSpec.DoubleValue COOLANT_TANK_MODULE_3__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER = COOLANT_TANK_MODULE_3__BUILDER.defineInRange(MPSConstants.ENERGY_CONSUMPTION_COOLING_BONUS_MULTIPLIER , 1, 0, 1000000D);
    ...
    private static final ModConfigSpec.DoubleValue COOLANT_TANK_MODULE_4__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER = COOLANT_TANK_MODULE_4__BUILDER.defineInRange(MPSConstants.ENERGY_CONSUMPTION_COOLING_BONUS_MULTIPLIER , 1, 0, 1000000D);
    ...
    public static double coolantTankModuleEnergyConsumptionCoolingBonusMultiplier1;
    public static double coolantTankModuleEnergyConsumptionMultiplier1;
    ...
    public static double coolantTankModuleEnergyConsumptionCoolingBonusMultiplier2;
    public static double coolantTankModuleEnergyConsumptionMultiplier2;
    ...
    public static double coolantTankModuleEnergyConsumptionCoolingBonusMultiplier3;
    public static double coolantTankModuleEnergyConsumptionMultiplier3;
    ...
    public static double coolantTankModuleEnergyConsumptionCoolingBonusMultiplier4;
    public static double coolantTankModuleEnergyConsumptionMultiplier4;
    ...
    public static void onLoad(final ModConfigEvent event) {
        if (event.getConfig().getSpec() == FLUID_STORAGE_MODULE_SPEC) {
            ...
            coolantTankModuleEnergyConsumptionCoolingBonusMultiplier1 = COOLANT_TANK_MODULE_1__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER.get();
            coolantTankModuleEnergyConsumptionMultiplier1 = COOLANT_TANK_MODULE_1__ENERGY_CONSUMPTION_MULTIPLIER.get();
            ...
            coolantTankModuleEnergyConsumptionCoolingBonusMultiplier2 = COOLANT_TANK_MODULE_2__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER.get();
            coolantTankModuleEnergyConsumptionMultiplier2 = COOLANT_TANK_MODULE_2__ENERGY_CONSUMPTION_MULTIPLIER.get();
            ...
            coolantTankModuleEnergyConsumptionCoolingBonusMultiplier3 = COOLANT_TANK_MODULE_3__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER.get();
            coolantTankModuleEnergyConsumptionMultiplier3 = COOLANT_TANK_MODULE_3__ENERGY_CONSUMPTION_MULTIPLIER.get();
            ...
            coolantTankModuleEnergyConsumptionCoolingBonusMultiplier4 = COOLANT_TANK_MODULE_4__ENERGY_CONSUMPTION_COOLANT_BONUS_MULTIPLIER.get();
            coolantTankModuleEnergyConsumptionMultiplier4 = COOLANT_TANK_MODULE_4__ENERGY_CONSUMPTION_MULTIPLIER.get();
        }
    }
}
