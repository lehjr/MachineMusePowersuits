    ...
    public class CapProvider implements ICapabilityProvider {
        ...
        public CapProvider(final ItemStack module) {
            ...
            powerModule = new PowerModule(module, ModuleCategory.ARMOR, ModuleTarget.ARMORONLY, MPSSettings::getModuleConfig) {
                ...
                {
                    addBaseProperty(MPSConstants.ARMOR_VALUE_PHYSICAL, 7.5, TagConstants.MODULE_TRADEOFF_PREFIX + MPSConstants.ARMOR_POINTS);
                    addBaseProperty(TagConstants.MAXIMUM_HEAT, 750);
