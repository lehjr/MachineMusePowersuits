...
public class DiamondPlatingModule extends AbstractPowerModule {
    public static class DiamondArmorPlatingCapabilityWrapper extends PowerModule {
        public DiamondArmorPlatingCapabilityWrapper(ItemStack module) {
            super(module, ModuleCategory.ARMOR, ModuleTarget.ARMORONLY);

            addBaseProperty(MPSConstants.ARMOR_VALUE_PHYSICAL,
                    ()-> () -> MPSCommonConfig.diamondPlatingArmorPhysical,
                    NuminaConstants.MODULE_TRADEOFF_PREFIX + MPSConstants.ARMOR_POINTS);

            addBaseProperty(NuminaConstants.MAXIMUM_HEAT,
                    ()-> () -> MPSCommonConfig.diamondPlatingMaxHeat);

            addBaseProperty(MPSConstants.KNOCKBACK_RESISTANCE,
                    ()-> () -> MPSCommonConfig.diamondPlatingKnockBackResistance);

            addBaseProperty(MPSConstants.ARMOR_TOUGHNESS,
                    ()-> () -> MPSCommonConfig.diamondPlatingArmorToughness);
        }
        ...
        public boolean isAllowed() {
            return MPSCommonConfig.diamondPlatingIsAllowed;
        }
    }
}