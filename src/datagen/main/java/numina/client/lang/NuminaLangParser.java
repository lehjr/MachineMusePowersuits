 ...
 * the updated keys.
 *
 * TODO: move language files to datagen and setup parsing from there
 */
public class NuminaLangParser implements DataProvider {
...
//    ExistingFileHelper.IResourceType resourceType = VanillaResourceType.LANGUAGES;// new net.minecraftforge.common.data.ExistingFileHelper.ResourceType(VanillaResourceType.LANGUAGES, ".json", "lang");
    ...
    public NuminaLangParser(DataGenerator gen, ExistingFileHelper existingFileHelper, String modid, String root) {
        this.gen = gen;
        this.modid = modid;
    ...
    public void run(CachedOutput cache) throws IOException {
        ...
        File langFolder = new File(src.toFile(), root + "/resources/assets/" + modid + "/src/datagen/powersuits/resources/assets/lang");
